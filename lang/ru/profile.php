...
return [
    '2fa' => [
        ...
        'secret_not_found' => 'Секретный ключ 2FA не найден. Пожалуйста, попробуйте настроить снова.',
        'invalid_code' => 'Неверный код 2FA. Пожалуйста, попробуйте снова.',
    ...
    'security_settings' => [
        ...
        'confirmation_method' => 'Способ подтверждения',
        'email_confirmation' => 'Подтверждение по email',
        'authenticator_confirmation' => 'Подтверждение через аутентификатор',
        'initiate_update' => 'Начать изменение',
        'confirm_update' => 'Подтвердить изменение',
        'cancel' => 'Отмена',
        ...
        'password_update_confirmation' => 'Подтверждение изменения пароля',
        'password_update_confirmation_text' => 'Для подтверждения изменения пароля используйте следующий код:',
        'verification_code' => 'Код подтверждения',
        'code_expires_in' => 'Код действителен в течение :minutes минут',
        'if_you_did_not_request' => 'Если вы не запрашивали изменение пароля, проигнорируйте это письмо.',
        'password_updated' => 'Пароль успешно изменен',
        'password_update_cancelled' => 'Изменение пароля отменено',
        'update_request_expired' => 'Срок действия запроса на изменение пароля истек',
