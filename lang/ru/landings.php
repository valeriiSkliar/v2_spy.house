...
return [
    ...
    'download' => [
        ...
        'status' => [
            'started' => [
                'title' => 'Загрузка сайта начата: :url',
                'message' => 'Начата загрузка сайта :url. Вы получите уведомление по завершении.',
            ],
            'completed' => [
                'title' => 'Загрузка сайта завершена: :url',
                'message' => 'Загрузка сайта :url успешно завершена.',
            ],
            'failed' => [
                'title' => 'Ошибка загрузки сайта: :url',
                'message' => 'Не удалось загрузить сайт :url.',
            ],
        ],
    ],
];
