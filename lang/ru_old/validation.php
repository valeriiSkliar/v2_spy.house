...
return [
    ...
    */
    ...
    'ip' => 'Поле :attribute должно быть действительным IP-адресом или диапазоном IP.',
    ...
    */
    ...
    'login_format' => 'Логин может содержать только буквы, цифры и нижние подчеркивания.',
    'telegram_format' => 'Введите корректный логин Telegram (начинающийся с @).',
    'phone_format' => 'Введите корректный номер телефона.',
    'messenger_contact_taken' => 'Данный контакт уже зарегистрирован для этого типа мессенджера.',
    'messenger_type_invalid' => 'Выберите корректный тип мессенджера.',
    'experience_invalid' => 'Выберите корректный уровень опыта.',
    'scope_of_activity_invalid' => 'Выберите корректную сферу деятельности.',
