    ...
    public function run(): void
    {
        ...
        foreach ($categories as $key => $categoryData) {
            ...
            foreach ($mockServices[$key] as $serviceData) {
                ...
                // Use factory to create service, overriding specific fields from mock data
                Service::factory()->create([
                    'name' => $serviceData['name'],
                    // description will be generated by the factory
                    ...
                    // Ensure other necessary fields from factory are used or overridden if needed
                    // e.g., views, transitions, rating, etc., will come from factory defaults
                    // redirect_url will also come from factory default
                ]);
            }
        }
    }
