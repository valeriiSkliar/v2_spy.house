...
/**
 * Initialize jQuery Validation for IP restriction form
 * @param {jQuery} $form - The form element
 * @param {boolean} isConfirmationStep - Whether the form is in confirmation step
 * @returns {object} - The validator instance
 */
function initIpRestrictionValidation($form, isConfirmationStep = false) {
...
/**
 * Add custom validation methods for IP restriction form
 */
function addCustomValidationMethods() {
  ...
  $.validator.addMethod(
    ...
    function (value, element) {
      return ValidationMethods.validateIpAddressList(value);
    },
    IP_RESTRICTION_CONFIG.errorMessage
  );
...
/**
 * Handle server validation errors for IP restriction form
 * @param {object} response - Server response with errors
 * @param {jQuery} $form - The form element
 */
function handleIpRestrictionValidationErrors(response, $form) {
  if (response.errors) {
...
export { handleIpRestrictionValidationErrors, initIpRestrictionValidation };