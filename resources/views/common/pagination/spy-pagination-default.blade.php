<nav class="pagination-nav" role="navigation" aria-label="pagination">
    ...
    <ul class="pagination-list">
        ...
        <li><a data-page="prev" class="pagination-link prev disabled" aria-disabled="true" href=""><span
                    class="icon-prev"></span> <span class="pagination-link__txt">Previous</span></a></li>
        @else
        <li><a data-page="prev" class="pagination-link prev" aria-disabled="false"
                href="{{ $paginator->previousPageUrl() }}"><span class="icon-prev"></span> <span
        ...
        <li><a data-page="{{ $page }}" class="pagination-link active" href="#" aria-current="page">{{ $page }}</a></li>
        @else
        <li><a data-page="{{ $page }}" class="pagination-link" href="{{ $url }}">{{ $page }}</a></li>
        @endif
        @endforeach
        @endif
        @endforeach
        ...
        <li><a data-page="next" class="pagination-link next" aria-disabled="false"
                href="{{ $paginator->nextPageUrl() }}"><span class="pagination-link__txt">Next</span> <span
                    class="icon-next"></span></a></li>
        @else
        <li><a data-page="next" class="pagination-link next disabled" aria-disabled="true" href=""><span
