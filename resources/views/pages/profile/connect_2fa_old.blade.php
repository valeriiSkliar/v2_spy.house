                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="mb-30">
                                    <div class="step-2fa__key">
                                        ...
                                        <button type="button" class="btn _flex _border-green mb-20 w-100" onclick="generateNewToken()">
                                    ...
                                    <div class="form-item mb-30">
                                        ...
                                        <div class="base-select base-select_big">
                                            <div class="base-select__trigger">
                                                <span class="base-select__value">{{ __('profile.2fa.authenticator_app') }}</span>
                                                <span class="base-select__arrow"></span>
                                            </div>
                                            <ul class="base-select__dropdown" style="display: none;">
                                                <li class="base-select__option is-selected">{{ __('profile.2fa.authenticator_app') }}</li>
