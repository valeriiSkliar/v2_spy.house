...
<form id="ip-restriction-form" action="{{ route('api.profile.update-ip-restriction') }}" method="POST" class="pt-3">
    ...
    <div class="col-lg-4 col-md-6 col-12 mb-20">
        ...
        <textarea name="ip_restrictions" class="auto-resize" rows="5" placeholder="{{ __('profile.ip_restriction.allowed_ip_addresses_placeholder') }}">{{ is_array($ip_restrictions) ? implode("\n", $ip_restrictions) : $ip_restrictions }}</textarea>
    ...
    <x-profile.submit-button formId="ip-restriction-form" id="ip-restriction-submit-button" :label="__('profile.save_button')" />
</form>