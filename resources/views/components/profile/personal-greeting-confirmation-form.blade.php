...
<form id="personal-greeting-form" action="{{ route('api.profile.confirm-personal-greeting-update') }}" method="POST" class="pt-3">
    @csrf
    ...
    <div class="d-flex gap-3 confirmation-method__btn">
        <x-profile.submit-button formId="personal-greeting-form" :label="__('profile.security_settings.confirm_button')" />
        <div class="mb-20">
            <a href="{{ route('api.profile.cancel-personal-greeting-update') }}" class="btn _flex _border-red _big">
