...
<form 
    id="{{ $config['form_id'] }}" 
    method="POST"
    @if($formType === 'email' || $formType === 'greeting') data-action="{{ route($actionRoute) }}" @endif
...
>
        ...
        <div class="col _offset20 mb-10">
            @if($formType === 'password')
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <x-profile.unified-input-field 
                        name="current_password" 
                        type="password"
                        :label="__('profile.security_settings.current_password_label')"
    ...
    @else
        ...
        <div class="d-flex gap-3">
            <x-profile.submit-button 
                :formId="$config['form_id']" 
                :label="__('profile.confirm_button')" 
            />
            <div class="mb-20">
