  ...
  plugins: [
    ...
    laravel({
      input: [
        ...
        'resources/js/pages/mainPage/bootstrap-datepicker.js',
        'resources/js/pages/mainPage/bootstrap-select.js',
        'resources/js/pages/mainPage/jquery.counterup.js',
        'resources/js/pages/mainPage/jquery.marquee.min.js',
        'resources/js/pages/mainPage/select2.min.js',
        'resources/js/pages/mainPage/swiper-bundle.js',
      ],
      refresh: true,
    }),
  ],
